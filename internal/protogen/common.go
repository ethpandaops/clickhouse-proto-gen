...
func (g *Generator) writeRangeTypes(sb *strings.Builder) {
	...
	sb.WriteString("    string regex = 8;              // Regular expression match\n")
	sb.WriteString("    string not_regex = 9;          // Regular expression not match\n")
	sb.WriteString("    StringList in = 10;            // In list of values\n")
	sb.WriteString("    StringList not_in = 11;        // Not in list of values\n")
	sb.WriteString("  }\n")
	sb.WriteString("}\n\n")
	...
	sb.WriteString("    StringList in = 10;            // In list of values\n")
	sb.WriteString("    StringList not_in = 11;        // Not in list of values\n")
	sb.WriteString("    google.protobuf.Empty is_null = 12;     // IS NULL check\n")
	sb.WriteString("    google.protobuf.Empty is_not_null = 13; // IS NOT NULL check\n")
	sb.WriteString("  }\n")
	sb.WriteString("}\n\n")
